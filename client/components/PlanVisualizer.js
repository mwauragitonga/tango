...
export default function PlanVisualizer({ plan, theme = "dark" }) {
  ...
  return (
    <div className={`mt-4 mb-4 p-4 rounded-lg border shadow-xl bg-bg-page/50 backdrop-blur-sm ${
      theme === "dark" ? "border-divider/50 shadow-black/40" : "border-divider shadow-slate-200"
    }`}>
